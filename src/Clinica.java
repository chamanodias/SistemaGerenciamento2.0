...
public class Clinica {
    ...
    public void criarPaciente(Scanner scanner) {
        ...
        String planoSaudeInput = scanner.next();
        boolean planoSaude = planoSaudeInput.equalsIgnoreCase("s");
   ...
   public void criarMedico(Scanner scanner) {
    ...
    String disponibilidadeInput = scanner.next();
    ...
    Medico novoMedico = new Medico(nome, disponibilidade, email, especializacao, 0);
    ...
    public void criarConsulta(Scanner scanner) {
        ...
        System.out.print("É prioridade? (s/n): ");
        String prioridadeInput = scanner.next();
        boolean prioridade = prioridadeInput.equalsIgnoreCase("s");
    ...
    public void exibirDadosMedico(Medico medico) {
        ...
        System.out.println("    E-mail: " + medico.getEmailMedico()); 
        System.out.println("    Especialização: " + medico.getEspecializacao());
        System.out.println("    Disponibilidade: " + (medico.getDisponibilidade() ? "Disponível" : "Indisponível"));
    }
